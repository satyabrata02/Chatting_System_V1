...
<html>
    ...
    <body>
        <nav class="navbar">
            <div class="content">
                ...
                <ul class="menu-list">
                    ...
                    <li><a href="about.jsp" style="color: blue">ABOUT</a></li>
                </ul>
        ...
        <div class="aboutp">
            <div class="card">
                <div class="imgBox">
                    <img src="pictures/satya2.jpg">
                    <img src="pictures/satya.jpg">
                </div>
                <div class="details">
                    <div class="contentp">
                        <h2>Developed by<br><span>Satyabrata Panda</span></h2>
            ...
            <div class="wrapper">
                <div class="flip-inner-wrapper">
                    ...
                    <div class="flip-back">
                        ...
                        <h2>Developed by<br><span>Satyabrata Panda</span></h2>
                        <span>( MCA Gradute )</span>
                        <p><img src="pictures/call.png">(+91) 6371202542</p>
                        <p><img src="pictures/mail.png">pandasatyabrata56@gmail.com</p>
                        <div class="social-icons">
